...
curl http://transitfeeds.com/p/wmata/75/20180520/download -L -o data/usa-dc-washington.zip
...
curl http://transitfeeds.com/p/abq-ride/52/20180515/download -L -o data/usa-nm-albuquerque.zip
...
curl http://transitfeeds.com/p/sfmta/60/20170815/download -L -o data/usa-ca-san-francisco.zip
